    ...
    storageProfile: {
      ...
      osDisk: {
        ...
        managedDisk: {
          ...
          id: resourceId('Microsoft.Compute/disks', '${virtualMachines_az104_06_vm0_name}_disk1_5f67e2f153f249f5ba7813a928e2f936')
        }
        deleteOption: 'Detach'
        diskSizeGB: 127
      }
  ...
  properties: {
    ...
    storageProfile: {
      ...
      osDisk: {
        ...
        managedDisk: {
          storageAccountType: 'Premium_LRS'
          id: resourceId('Microsoft.Compute/disks', '${virtualMachines_az104_06_vm1_name}_disk1_423e698686ba46d69e565d9c2602a72c')
        }
        deleteOption: 'Detach'
        diskSizeGB: 127
      }
  ...
  properties: {
    ...
    storageProfile: {
      ...
      osDisk: {
        ...
        managedDisk: {
          storageAccountType: 'Premium_LRS'
          id: resourceId('Microsoft.Compute/disks', '${virtualMachines_az104_06_vm2_name}_disk1_5d399934081f4e329b6661bc3016065b')
        }
        deleteOption: 'Detach'
        diskSizeGB: 127
      }
  ...
  properties: {
    ...
    storageProfile: {
      ...
      osDisk: {
        ...
        managedDisk: {
          storageAccountType: 'Premium_LRS'
          id: resourceId('Microsoft.Compute/disks', '${virtualMachines_az104_06_vm3_name}_disk1_3e2351396660410c814d94fc61ac9e25')
        }
        deleteOption: 'Detach'
        diskSizeGB: 127
      }
...
resource networkSecurityGroups_az104_06_nsg01_name_default_allow_http 'Microsoft.Network/networkSecurityGroups/securityRules@2022-07-01' = {
  name: '${networkSecurityGroups_az104_06_nsg01_name}/default-allow-http'
  properties: {
    protocol: 'Tcp'
    sourcePortRange: '*'
  ...
  dependsOn: [
    networkSecurityGroups_az104_06_nsg01_name_resource
  ]
}

resource networkSecurityGroups_az104_06_nsg2_name_default_allow_http 'Microsoft.Network/networkSecurityGroups/securityRules@2022-07-01' = {
  name: '${networkSecurityGroups_az104_06_nsg2_name}/default-allow-http'
  properties: {
    protocol: 'Tcp'
    sourcePortRange: '*'
    destinationPortRange: '80'
  ...
  dependsOn: [
    networkSecurityGroups_az104_06_nsg2_name_resource
  ]
}

resource networkSecurityGroups_az104_06_nsg3_name_default_allow_http 'Microsoft.Network/networkSecurityGroups/securityRules@2022-07-01' = {
  name: '${networkSecurityGroups_az104_06_nsg3_name}/default-allow-http'
  properties: {
    protocol: 'Tcp'
    sourcePortRange: '*'
    destinationPortRange: '80'
  ...
  dependsOn: [
    networkSecurityGroups_az104_06_nsg3_name_resource
  ]
}

resource networkSecurityGroups_az104_06_nsg01_name_default_allow_rdp 'Microsoft.Network/networkSecurityGroups/securityRules@2022-07-01' = {
  name: '${networkSecurityGroups_az104_06_nsg01_name}/default-allow-rdp'
  properties: {
    protocol: 'Tcp'
    sourcePortRange: '*'
...
resource networkSecurityGroups_az104_06_nsg2_name_default_allow_rdp 'Microsoft.Network/networkSecurityGroups/securityRules@2022-07-01' = {
  name: '${networkSecurityGroups_az104_06_nsg2_name}/default-allow-rdp'
  properties: {
    protocol: 'Tcp'
    sourcePortRange: '*'
    destinationPortRange: '3389'
...
resource networkSecurityGroups_az104_06_nsg3_name_default_allow_rdp 'Microsoft.Network/networkSecurityGroups/securityRules@2022-07-01' = {
  name: '${networkSecurityGroups_az104_06_nsg3_name}/default-allow-rdp'
  properties: {
    protocol: 'Tcp'
    sourcePortRange: '*'
    destinationPortRange: '3389'
    ...
    routes: [
      {
        ...
        id: routeTables_az104_06_rt23_name_az104_06_route_vnet2_to_vnet3.id
        properties: {
    ...
    routes: [
      {
        ...
        id: routeTables_az104_06_rt32_name_az104_06_route_vnet3_to_vnet2.id
        properties: {
...
resource routeTables_az104_06_rt23_name_az104_06_route_vnet2_to_vnet3 'Microsoft.Network/routeTables/routes@2022-07-01' = {
  name: '${routeTables_az104_06_rt23_name}/az104-06-route-vnet2-to-vnet3'
  properties: {
    addressPrefix: '10.63.0.0/24'
    nextHopType: 'VirtualAppliance'
    nextHopIpAddress: '10.60.0.4'
  ...
  dependsOn: [
    routeTables_az104_06_rt23_name_resource
  ]
}

resource routeTables_az104_06_rt32_name_az104_06_route_vnet3_to_vnet2 'Microsoft.Network/routeTables/routes@2022-07-01' = {
  name: '${routeTables_az104_06_rt32_name}/az104-06-route-vnet3-to-vnet2'
  properties: {
    addressPrefix: '10.62.0.0/24'
    nextHopType: 'VirtualAppliance'
    nextHopIpAddress: '10.60.0.4'
  ...
  dependsOn: [
    routeTables_az104_06_rt32_name_resource
  ]
}
...
resource applicationGateways_az104_06_appgw5_name_resource 'Microsoft.Network/applicationGateways@2022-07-01' = {
  ...
  properties: {
    ...
    frontendIPConfigurations: [
      {
        ...
        id: '${applicationGateways_az104_06_appgw5_name_resource.id}/frontendIPConfigurations/appGwPublicFrontendIp'
        properties: {
    ...
    frontendPorts: [
      {
        name: 'port_80'
        id: '${applicationGateways_az104_06_appgw5_name_resource.id}/frontendPorts/port_80'
        properties: {
          port: 80
        }
      }
    ...
    backendAddressPools: [
      {
        ...
        id: '${applicationGateways_az104_06_appgw5_name_resource.id}/backendAddressPools/${applicationGateways_az104_06_appgw5_name}-be1'
        properties: {
          backendAddresses: [
            {
              ipAddress: '10.62.0.4'
    ...
    backendHttpSettingsCollection: [
      {
        ...
        id: '${applicationGateways_az104_06_appgw5_name_resource.id}/backendHttpSettingsCollection/${applicationGateways_az104_06_appgw5_name}-http1'
        properties: {
          port: 80
          protocol: 'Http'
    ...
    httpListeners: [
      {
        ...
        id: '${applicationGateways_az104_06_appgw5_name_resource.id}/httpListeners/${applicationGateways_az104_06_appgw5_name}-rl1l1'
        properties: {
    ...
    requestRoutingRules: [
      {
        ...
        id: '${applicationGateways_az104_06_appgw5_name_resource.id}/requestRoutingRules/${applicationGateways_az104_06_appgw5_name}-rl1'
        properties: {
          ruleType: 'Basic'
          priority: 1
          httpListener: {
...
resource networkInterfaces_az104_06_nic0_name_resource 'Microsoft.Network/networkInterfaces@2022-07-01' = {
  ...
  properties: {
    ipConfigurations: [
      {
        name: 'ipconfig1'
        id: '${networkInterfaces_az104_06_nic0_name_resource.id}/ipConfigurations/ipconfig1'
        ...
        properties: {
          ...
          loadBalancerBackendAddressPools: [
            {
              id: '${loadBalancers_az104_06_lb4_externalid}/backendAddressPools/az104-06-lb4-be1'
            }
          ]
        }
      }
...
resource networkInterfaces_az104_06_nic1_name_resource 'Microsoft.Network/networkInterfaces@2022-07-01' = {
  ...
  properties: {
    ipConfigurations: [
      {
        name: 'ipconfig1'
        id: '${networkInterfaces_az104_06_nic1_name_resource.id}/ipConfigurations/ipconfig1'
...
resource networkInterfaces_az104_06_nic2_name_resource 'Microsoft.Network/networkInterfaces@2022-07-01' = {
  ...
  properties: {
    ipConfigurations: [
      {
        name: 'ipconfig1'
        id: '${networkInterfaces_az104_06_nic2_name_resource.id}/ipConfigurations/ipconfig1'
...
resource networkInterfaces_az104_06_nic3_name_resource 'Microsoft.Network/networkInterfaces@2022-07-01' = {
  ...
  properties: {
    ipConfigurations: [
      {
        name: 'ipconfig1'
        id: '${networkInterfaces_az104_06_nic3_name_resource.id}/ipConfigurations/ipconfig1'
    ...
    securityRules: [
      {
        ...
        id: networkSecurityGroups_az104_06_nsg01_name_default_allow_rdp.id
      ...
      }
      {
        ...
        id: networkSecurityGroups_az104_06_nsg01_name_default_allow_http.id
        type: 'Microsoft.Network/networkSecurityGroups/securityRules'
        properties: {
          protocol: 'Tcp'
          sourcePortRange: '*'
...
resource networkSecurityGroups_az104_06_nsg2_name_resource 'Microsoft.Network/networkSecurityGroups@2022-07-01' = {
  ...
  properties: {
    securityRules: [
      {
        name: 'default-allow-rdp'
        id: networkSecurityGroups_az104_06_nsg2_name_default_allow_rdp.id
        type: 'Microsoft.Network/networkSecurityGroups/securityRules'
        properties: {
          protocol: 'Tcp'
          sourcePortRange: '*'
      ...
      {
        name: 'default-allow-http'
        id: networkSecurityGroups_az104_06_nsg2_name_default_allow_http.id
        type: 'Microsoft.Network/networkSecurityGroups/securityRules'
        properties: {
          protocol: 'Tcp'
          sourcePortRange: '*'
...
resource networkSecurityGroups_az104_06_nsg3_name_resource 'Microsoft.Network/networkSecurityGroups@2022-07-01' = {
  ...
  properties: {
    securityRules: [
      {
        name: 'default-allow-rdp'
        id: networkSecurityGroups_az104_06_nsg3_name_default_allow_rdp.id
        type: 'Microsoft.Network/networkSecurityGroups/securityRules'
        properties: {
          protocol: 'Tcp'
          sourcePortRange: '*'
      ...
      {
        name: 'default-allow-http'
        id: networkSecurityGroups_az104_06_nsg3_name_default_allow_http.id
        type: 'Microsoft.Network/networkSecurityGroups/securityRules'
        properties: {
          protocol: 'Tcp'
          sourcePortRange: '*'
...
resource virtualNetworks_az104_06_vnet2_name_resource 'Microsoft.Network/virtualNetworks@2022-07-01' = {
  ...
  properties: {
    ...
    virtualNetworkPeerings: [
      {
        name: '${virtualNetworks_az104_06_vnet2_name}_to_az104-06-vnet01'
        id: virtualNetworks_az104_06_vnet2_name_virtualNetworks_az104_06_vnet2_name_to_az104_06_vnet01.id
        properties: {
          peeringState: 'Connected'
          peeringSyncLevel: 'FullyInSync'
          remoteVirtualNetwork: {
...
resource virtualNetworks_az104_06_vnet3_name_resource 'Microsoft.Network/virtualNetworks@2022-07-01' = {
  ...
  properties: {
    ...
    virtualNetworkPeerings: [
      {
        name: '${virtualNetworks_az104_06_vnet3_name}_to_az104-06-vnet01'
        id: virtualNetworks_az104_06_vnet3_name_virtualNetworks_az104_06_vnet3_name_to_az104_06_vnet01.id
        properties: {
          peeringState: 'Connected'
          peeringSyncLevel: 'FullyInSync'
          remoteVirtualNetwork: {
...
resource virtualNetworks_az104_06_vnet01_name_resource 'Microsoft.Network/virtualNetworks@2022-07-01' = {
  ...
  properties: {
    ...
    virtualNetworkPeerings: [
      {
        name: '${virtualNetworks_az104_06_vnet01_name}_to_az104-06-vnet2'
        id: virtualNetworks_az104_06_vnet01_name_virtualNetworks_az104_06_vnet01_name_to_az104_06_vnet2.id
        properties: {
          peeringState: 'Connected'
          peeringSyncLevel: 'FullyInSync'
          remoteVirtualNetwork: {
      ...
      {
        name: '${virtualNetworks_az104_06_vnet01_name}_to_az104-06-vnet3'
        id: virtualNetworks_az104_06_vnet01_name_virtualNetworks_az104_06_vnet01_name_to_az104_06_vnet3.id
        properties: {
          peeringState: 'Connected'
          peeringSyncLevel: 'FullyInSync'
          remoteVirtualNetwork: {
